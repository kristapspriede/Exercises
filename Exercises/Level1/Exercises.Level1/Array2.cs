...
namespace Exercises.Level1
{
    ...
    public class Array2
    {
        ...
        public bool Either24(int[] nums)
        {
            ...
            if (isTwos == true && isFours == true)
            {
                return false;
            }
            else if (isTwos == true || isFours == true)
            {
                return true;
            }
            else
